...
class AddedItem {
	...
	def userLoginAndNavigateToHomepage() {
		println("\n I am inside userLoginAndNavigateToHomepage")
	}

	@When("User click buy icon")
	def userClickBuyIcon() {
		println("\n I am inside userClickBuyIcon")
	}
	...
	def userClickButtonForAddedItem() {
		println("\n userClickButtonForAddedItem")
	}
}